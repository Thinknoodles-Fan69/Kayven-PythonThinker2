...
question = float(input("How much do you save today after in school, eating recess, eating lunch, buy football card, betting with your friends, eating dinner, going to the movie"))