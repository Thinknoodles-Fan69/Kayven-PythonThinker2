...
guess = input("Who do you think will win this long and tiring race which includes loads of obstacles and challenges in this competition called 'The Torti=oise Challenge")
