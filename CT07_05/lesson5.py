...
if Power1 > Power2:
    Game = "The winner of this exciting match with consist of AI bot and " + name + "is..........." + name + ". Lets congratulate the" + name + "for being the winner of the competition and lets give him/her the trophy. Ronud of applause everyone!"
else:
    Over = "The winner of this exciting match with consist of AI bot and " + name + "is...........the AI bot. Lets congratulate the AI bot for being the winner of the competition and lets give him the trophy. Ronud of applause everyone!" 
...
print(name + " pokemon is the " + Pokemon1 + ". Will he/she achieve victory with this pokemon? Let us give him/her a round of applause for him getting a good pokemon!")
